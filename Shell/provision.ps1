...
$PackagesCygwin = "bind-utils,cron,curl,diffutils,dos2unix,gcc,git,gnupg2,less,lftp,make,man-db,mingw64-x86_64-gcc-core,mingw64-x86_64-gcc-g++,msmtp,nc,openssh,openssl,patch,perl-URI,procps-ng,python2,python3,rsync,ssh-pageant,tmux,zsh,vim,wget,whois"
$StepLimit = 14;
$UserName = "lucio"
