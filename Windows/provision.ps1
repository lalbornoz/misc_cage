...
$PackagesChocolatey = "7zip.install audacity audacity-lame birdtray classic-shell Cygwin dejavufonts electrum firefox f.lux foobar2000 foxitreader hashcheck keepass.install nvidia-display-driver mpc-hc mumble OpenOffice openvpn PDFCreator processhacker putty.install python3 rufus speedfan sysinternals thunderbird tor-browser vim vscode winfsp wireshark"
