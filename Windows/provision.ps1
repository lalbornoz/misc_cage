...
$PackagesCygwin = "bind-utils,cron,curl,diffutils,dos2unix,gcc,git,gnupg2,less,lftp,make,man-db,mingw64-x86_64-gcc-core,mingw64-x86_64-gcc-g++,msmtp,nc,openssh,openssl,patch,perl-URI,procps-ng,psmisc,python2,python3,rsync,socat,ssh-pageant,tmux,unzip,zsh,vim,wget,whois,zip"
$StepLimit = 14;
$UserName = "lucio"
